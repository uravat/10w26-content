...
### You will start this during lecture, continue working on it during Section 1 and complete and upload your knitted `.html` file and a  a `.zip` file, containing: your `.html` file, your `.Rmd` file, and any other relevant files to Canvas using the submission link for homework 01.
...
a. you have completed all exercises in the worksheet .Rmd file
